...
if __name__ == "__main__":
    if not GROQ_API_KEY:
        print("GROQ_API_KEY is not set. Set the environment variable GROQ_API_KEY or edit this file to add it.")
    elif not os.path.exists(IMAGE_PATH):
        print(f"Image file not found: {IMAGE_PATH}. Place an image at that path or change IMAGE_PATH in test.py")
    else:
        try:
